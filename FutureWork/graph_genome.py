...
#        self.drifting_sigma = None
	...
	# AZ - fix - NoneType arithmetic raises exceptions
        self.crossover_prob = 0.8
        self.add_prob = 0.05
        self.del_prob = 0.05
        self.new_start_prob = 0.01
        self.big_change_prob = 0.0
        self.change_edge_prob = 0.05
        self.mutate_par_sigma = 0.01
        self.mutate_par_prob = 0.01

        self.drifting_sigma = 0.01
...
#        tree = nx.dfs_tree(self.graph, source=self.starting_node)
    ...
    def __repr__(self):
#        out_str = pyevolve.GenomeBase.GenomeBase.__repr__(self) + "\n"
	out_str = ""
